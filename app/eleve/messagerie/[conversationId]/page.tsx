...
interface EleveMessagerieConversationPageProps {
  params: {
    conversationId: string
  }
}

export default async function EleveMessagerieConversationPage({ params }: EleveMessagerieConversationPageProps) {
