...
import { School, LayoutDashboard, Users, Building, Settings, LogOut, Menu, X } from "lucide-react"
...
export function DashboardShell({ children }: DashboardShellProps) {
  ...
  const navigation = [
    ...
    { name: "Établissements", href: "/dashboard/etablissements", icon: Building },
        ...
        <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white shadow">
          ...
          <div className="flex flex-1 justify-between px-4">
            <div className="flex flex-1 items-center">
              <div className="flex items-center">
                <span className="font-medium text-gray-900">Administration Centrale</span>
