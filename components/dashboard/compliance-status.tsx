  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="text-lg font-medium">Conformité RGPD</CardTitle>
      </CardHeader>
                ...
                <Badge
                  ...
                  className={
                    item.status === "compliant"
                      ? "bg-green-500/10 text-green-500 hover:bg-green-500/10 hover:text-green-500 flex-shrink-0"
                      : item.status === "warning"
                        ? "bg-yellow-500/10 text-yellow-500 hover:bg-yellow-500/10 hover:text-yellow-500 flex-shrink-0"
                        : "bg-destructive/10 text-destructive hover:bg-destructive/10 hover:text-destructive flex-shrink-0"
                  }
                >
                  {item.status === "compliant" && "OK"}
                  {item.status === "warning" && "À voir"}
                  {item.status === "non-compliant" && "Non"}
                </Badge>
